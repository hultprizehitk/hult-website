...
// Variants mirror client-v3/components/ui/button.tsx (admin dashboard design system).
const buttonVariants = cva(
  "relative inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-lg border font-medium text-base outline-none transition-all focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg:not([class*='opacity-'])]:opacity-80 [&_svg:not([class*='size-'])]:size-4.5 sm:[&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0 sm:text-sm",
  {
    ...
    variants: {
      ...
      variant: {
        default: "border-white/20 bg-white text-neutral-900 shadow-sm hover:bg-neutral-100 hover:text-black active:bg-neutral-200",
        destructive: "border-rose-500/40 bg-rose-600 text-white shadow-sm hover:bg-rose-500 active:bg-rose-700",
        "destructive-outline":
        ...
        ghost: "border-transparent text-white/80 hover:bg-white/10 hover:text-white active:bg-white/15",
        ...
        secondary: "border-white/10 bg-[#16161d] text-neutral-100 hover:bg-[#202028] active:bg-neutral-700",
        emerald: "border-emerald-500/40 bg-emerald-600 text-white shadow-sm hover:bg-emerald-500 active:bg-emerald-700",
      },
    },
  }
)
