...
export interface ISiteContent extends Document {
  ...
  title: string; // Member Name, Announcement Title, Sponsor Name
  subtitle?: string; // Role ("Tech Lead"), Sponsor Tier ("Gold Partner")
  category: string; // "cd", "dcd", "tech", "event_management", "workshop", "sponsor", etc.
  description?: string;
  image?: string; // Photo URL / Logo URL
  links?: {
    linkedin?: string;
    github?: string;
    email?: string;
