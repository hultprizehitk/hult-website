      ...
      <div className="py-6 text-center space-y-3 font-sans">
        ...
        <div className="pt-2">
          <button
            ...
            className="inline-flex items-center gap-2.5 rounded-full bg-white hover:bg-neutral-50 border border-pink-200/80 px-6 py-2.5 text-xs font-bold text-[#1a0812] shadow-sm transition-all hover:scale-[1.02] cursor-pointer"
          >
